...
@section('content')
    ...
    <div class="flex justify-between mb-4">
        <h1 class="text-2xl font-bold font-lobster border-b-2 border-teal-500">suppliers</h1>
        <a href="{{ route('suppliers.create') }}" class="bg-teal-500 text-white px-4 py-2 rounded">
            + Add supplier
        </a>
    </div>
                    ...
                    @foreach($suppliers as $supplier)
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 text-center space-x-2">
                                ...
                                <a href="{{ route('suppliers.edit', $supplier) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-medium
